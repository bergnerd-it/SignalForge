...
public class ChatConfig {
    ...
    public LlmClient llmClient(
            @Value("${finally.llm.provider:openai}") String provider,
            @Value("${finally.llm.base-url:}") String baseUrl,
            @Value("${finally.llm.api-key:}") String apiKey,
            @Value("${finally.llm.model:}") String model,
