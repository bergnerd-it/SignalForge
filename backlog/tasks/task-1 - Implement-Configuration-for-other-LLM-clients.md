...
- [x] #2 Configuration properties under signalforge.llm (provider, base-url, api-key, model, mock) with environment variable mappings
...
2. Update ChatConfig with generic properties under signalforge.llm with fallback for backwards compatibility.
...
<!-- SECTION:NOTES:BEGIN -->
Implemented unified OpenAiCompatibleLlmClient with support for OpenRouter, OpenAI, Ollama, Groq, and custom endpoints. Added generic configuration properties under signalforge.llm with backwards-compatible fallback for OPENROUTER_API_KEY. Added OpenAiCompatibleLlmClientTest and ChatConfigTest.
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
Implemented unified OpenAI-compatible LLM client and generic configuration namespace under signalforge.llm with multi-provider presets (OpenRouter, OpenAI, Ollama, Groq, custom). Verified with unit and integration test suites in Gradle.
